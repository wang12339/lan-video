...
import com.lanvideo.player.databinding.DialogLoginBinding
...
class LoginDialog : DialogFragment() {
    ...
    private fun toggleMode() {
        ...
        if (isRegisterMode) {
            binding.loginTitle.text = getString(com.lanvideo.player.R.string.login_btn_register)
            binding.loginSubtitle.setText(com.lanvideo.player.R.string.login_subtitle)
            binding.inputConfirmLayout.isVisible = true
            binding.btnSubmit.text = getString(com.lanvideo.player.R.string.login_btn_register)
            binding.btnToggleMode.text = getString(com.lanvideo.player.R.string.login_toggle_login)
        } else {
            binding.loginTitle.text = getString(com.lanvideo.player.R.string.login_title)
            binding.loginSubtitle.setText(com.lanvideo.player.R.string.login_subtitle)
            binding.inputConfirmLayout.isVisible = false
            binding.btnSubmit.text = getString(com.lanvideo.player.R.string.login_btn_login)
            binding.btnToggleMode.text = getString(com.lanvideo.player.R.string.login_toggle_register)
        }
        ...
        lifecycleScope.launch {
            ...
            when (result) {
                is AuthResult.Ok -> {
                    ...
                    // Trigger HomeFragment reload
                    com.lanvideo.player.MyApplication.instance
                        .notifyLanServerEvent(com.lanvideo.player.data.network.NetworkModule.getBaseUrl())
