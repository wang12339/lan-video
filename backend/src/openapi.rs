...
#[openapi(
    ...
    paths(
        ...
        crate::handlers::admin::admin_system::track_action_public,
        crate::handlers::client_errors::report_client_error,
    ...
    components(schemas(
        ...
        crate::models::admin::AdminUsersQuery,
        crate::handlers::client_errors::ClientErrorReport,
