...
- `backend/docs/performance_optimization.md` - 性能优化文档
...
#### 修改的配置文件
- `backend/Cargo.toml` - 添加 `once_cell` 依赖
- `backend/src/util/mod.rs` - 添加性能监控模块
- `backend/src/handlers/admin/mod.rs` - 添加性能监控处理器
- `backend/src/app.rs` - 添加性能监控路由
